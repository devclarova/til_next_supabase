...
- `Prettier - Code formatter` 확장 프로그램 설치 필요
...
### 4.5. 명령어로 포맷팅을 한번에 실행하도록 스크립트 작성(선택)
...
### 5.2. Prettier와 ESLint 통합 설정

- ESLint와 Prettier 충돌하지 않도록 설정
